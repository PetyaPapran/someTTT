...
JButton btnEmpty[] = new JButton[101];
...
final int X = 535, Y = 342,
	mainColorR = 255, mainColorG = 152, mainColorB = 50,	//some fucking orange, like 255, 102, 0
	btnColorR = 70, btnColorG = 70, btnColorB = 70;		//dark grey
...
//Setting Menu, Main, Top, Bottom Panel Layout/Backgrounds
	...
	pnlNewGame.setBackground(new Color(mainColorR - 0, mainColorG - 50, mainColorB- 50));
	pnlMenu.setBackground(new Color((mainColorR - 0), (mainColorG - 50), (mainColorB- 50)));
...
//Setting up the playing field
	pnlPlayingField.setLayout(new GridLayout(10, 10, 2, 2));
